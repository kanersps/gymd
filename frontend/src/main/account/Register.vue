    ...
    <div class="p-3 mt-10 w-full md:w-1/3">
      ...
      <form @submit="submitForm" class="grid grid-cols-1 gap-3 flex mt-4 w-full">
        ...
        <div class="border shadow rounded flex items-center">
          <input
              v-on:blur="touchedInput('password')" v-on:keydown="inputChanged('password')" v-model="password"
          ...
          <div @click="displayPassword = !displayPassword" class="inline mr-2 cursor-pointer">
            <svg v-if="!displayPassword" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 inline" fill="none"
        ...
        <div>
          <input v-model="terms" class="shadow border rounded text-gray-700 bg-red-800 leading-tight" type="checkbox"
                 id="terms">&nbsp;
